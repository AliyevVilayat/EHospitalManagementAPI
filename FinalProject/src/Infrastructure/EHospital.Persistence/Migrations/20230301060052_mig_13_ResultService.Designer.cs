...
namespace EHospital.Persistence.Migrations
{
    ...
    [Migration("20230301060052_mig_13_ResultService")]
    partial class mig_13_ResultService
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.Registration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.ResultService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.Registration", b =>
                {
                    ...
                    b.HasOne("EHospital.Domain.Entities.Receptionist", "Receptionist")
                        .WithMany("Registrations")
                        .HasForeignKey("ReceptionistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EHospital.Domain.Entities.Room", "Room")
                        .WithMany("Registrations")
            ...
            modelBuilder.Entity("EHospital.Domain.Entities.ResultService", b =>
                {
                    b.HasOne("EHospital.Domain.Entities.Registration", "Registration")
                        .WithMany("ResultServices")
